...
| 적용 상태 | 근거 문서 |
| 다루는 범위 | Vision 2D·3D body pose, observation confidence, face, person mask, 카메라 depth |
| 제품 내 역할 | Vision 2D [analysis.md](analysis.md), [related-vision-3d.md](related-vision-3d.md), [related-person-observations.md](related-person-observations.md)의 API 사실 추적 |
...
| Vision 3D는 17-joint skeleton이며 dense depth가 아님 | Apple 공식 | `VNDetectHumanBodyPose3DRequest`, WWDC23 |
