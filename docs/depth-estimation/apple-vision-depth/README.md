...
- → 메뉴바 앱 번들·상시 백그라운드 추론엔 **과도하게 무겁다.** turtlemeck엔 부적합. (metric 출력이 매력적이나 비용 대비 비현실.)
...
| Core ML Depth Pro | ✅(이론상) | metric | 1.9 GB | 0.3s/2.25MP, CoreML 변환본 없음 | ❌ 과중 |
