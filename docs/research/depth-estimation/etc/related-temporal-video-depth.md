...
단일 이미지 depth 모델을 영상의 각 프레임에 독립 적용하면 temporal flicker가 생길 수 있다.
Video Depth Anything은 이 문제를 직접 다루며 긴 영상에서 일관된 relative depth를 만드는 것을 목표로 한다.
...
- 채택 DA-V2 분석: [Depth Anything V2](../../../depth-estimation/depth-anything-v2/analysis.md)
- 확정 워크플로우: [자세 분석 상세 워크플로우](../../../algorithm/posture-analysis-workflow.md)
